...
\begin{center}
  ...
  {\fontsize{20}{20}\selectfont\scshape\textls[200]{Curriculum Vitae}}\footnote{Updated on \( {10}^{\text{th}} \)August, 2025}
...
\begin{center}
  ...
  \begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
    ...
    \gray Advisor & Prof. Thomas Koberda and Prof. Sara Maloni\\
