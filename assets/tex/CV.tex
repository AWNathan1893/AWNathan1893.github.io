...
\begin{center}
  ...
  {\fontsize{20}{20}\selectfont\scshape\textls[200]{Resum\'e}}
  ...
  \begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
    \gray Period     & \textbf{2021 --- Present}                                     \\
    \gray Degree     & \textbf{Bachelor of Mathematics (Honours)}                    \\
    \gray Score      & \textbf{2309/2500} (for first five semesters)                 \\
    \gray Percentage & \textbf{92.36\%}                                              \\
  ...
  \begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
    ...
    \gray Degree     & \textbf{Class XII (Higher Secondary School)}                              \\
    \gray Score      & \textbf{578/600}                                                          \\
    \gray Percentage & \textbf{96.3\%}                                                           \\
  ...
  \begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
    \gray Period     & \textbf{2018 --- 2019}                                                    \\
    \gray Degree     & \textbf{Class X (Secondary School)}                                       \\
    \gray Score      & \textbf{482/500}                                                          \\
    \gray Percentage & \textbf{96.4\%}                                                           \\
    \gray School     & \textbf{Aditya Academy Secondary, Kadambagachi} \hfill West Bengal, India \\
    %& Extra information about degree
  \end{tabularx}
