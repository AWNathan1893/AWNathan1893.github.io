...
\begin{center}
  ...
  {\fontsize{20}{20}\selectfont\scshape\textls[200]{Curriculum Vitae}}\footnote{Last updated: \( {11}^{\text{th}} \)July, 2024}
  \vspace{0.5 cm} % Extra whitespace after the large name at the top

  % \section{Objective}

  % Becoming a successful mathematican working on problems in geometry and topology, \\
  % and contributing to a sustainable future for humanity
  ...
  \begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
    \gray Period & \textbf{2018 --- 2021}                                                    \\
    \gray Degree & \textbf{Secondary \& Higher Secondary school}                             \\
    \gray School & \textbf{Aditya Academy Secondary, Kadambagachi} \hfill West Bengal, India \\
    %& Extra information about degree
  \end{tabularx}
  ...
  \begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
    \gray Period     & \textbf{January - April 2024}                                         \\
    \gray Organisers & \textbf{Prof. Charanya Ravi, Prof. Jishnu Biswas, Prof. Manish Kumar} \\
    \gray Program    & \textbf{Reading Seminar} \hfill ISI Bangalore                         \\
    % \gray Organiser & \textbf{IASc, INSA, NASI}                          \\
    \gray Topic      & \textbf{Intersection homology}                                        \\
  \end{tabularx}

  \vspace{12pt}

  \begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
    \gray Period  & \textbf{May - July 2023}                           \\
    \gray Guide   & \textbf{Prof. Subhojoy Gupta}\hfill IISc Bangalore \\
    \gray Program & \textbf{Summer Research Fellowship Program}        \\
    % \gray Organiser & \textbf{IASc, INSA, NASI}                          \\
    \gray Topic   & \textbf{Geometry and Topology of Surfaces}         \\
  \end{tabularx}

  \vspace{12pt}

  \begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
    \gray Period    & \textbf{June - July 2023}                                             \\
    \gray Organiser & \textbf{Prof. Apoorva Khare, Prof. R Venkatesh} \hfill IISc Bangalore \\
    \gray Program   & \textbf{Advanced Instruction School}                                  \\
    \gray Topic     & \textbf{Lie Groups and Lie Algebras}                                  \\
  \end{tabularx}
  ...
  \begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
    ...
    % , based on the book \textit{Geometric Algebra} by Emil Artin \\
  \end{tabularx}
